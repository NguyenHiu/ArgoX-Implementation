...
func (c *OrderAppClient) HandleProposal(p client.ChannelProposal, r *client.ProposalResponder) {
	...
	c.channels <- newOrderChannel(ch)
}

// HandleUpdate is the callback for incoming channel updates.
func (c *OrderAppClient) HandleUpdate(cur *channel.State, next client.ChannelUpdate, r *client.UpdateResponder) {

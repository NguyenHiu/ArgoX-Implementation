...
func (c *TradeAppClient) WalletAddress() common.Address {
...
func (c *TradeAppClient) WalletAddressAsEthwallet() *ethwallet.Address {
...
func (c *TradeAppClient) WireAddress() *ethwallet.Address {

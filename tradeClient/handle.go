...
func (c *TradeAppClient) HandleProposal(p client.ChannelProposal, r *client.ProposalResponder) {
	...
	c.channels <- newTradeChannel(ch)
}

// HandleUpdate is the callback for incoming channel updates.
func (c *TradeAppClient) HandleUpdate(cur *channel.State, next client.ChannelUpdate, r *client.UpdateResponder) {
